...
为了使[1,3]和[3,1]不一样，**先遍历背包容量**，这样保证会出现[3,1]的情况

> 组合就是正常的背包问题，排列需要**先**遍历背包容量
...
> 对于一维dp来说，当前物品只有如何放不放的问题，因为拿出来**判断**的物品一定是可以放下的，我们只需要关心当前物品放入之后价值是否会增加
